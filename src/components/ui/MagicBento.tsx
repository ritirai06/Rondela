            ...
            return (
              ...
              >
                <div className="magic-bento-card__header">
                  ...
                  {IconComponent && (
                    <div className="w-12 h-12 rounded-xl bg-black/5 flex items-center justify-center text-current">
                ...
                <div className="magic-bento-card__content">
                  ...
                  <p className="magic-bento-card__description">{card.desc || card.description}</p>
                </div>
              </ParticleCard>
            );
          }
